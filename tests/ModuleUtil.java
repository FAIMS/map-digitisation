...
public class ModuleUtil extends ModuleHelper {
    ...
    /*
        ...
        Ref:  Shape/Vars
     */
    public static View get_Shape_Vars(Solo solo) {
        String ref = "Shape/Vars";
        return (android.view.View) solo.getView((Object) ref);
    }
    ...
    /*
        Type: button
        Ref:  Control/IDs/Assign_Colour
     */
    public static View get_Control_IDs_AssignColour(Solo solo) {
        String ref = "Control/IDs/Assign_Colour";
        return (android.view.View) solo.getView((Object) ref);
    }
    ...
    /*
        Type: dropdown
        Ref:  Control/IDs/Colour_to_Assign
     */
    public static View get_Control_IDs_ColourtoAssign(Solo solo) {
    ...
    /*
        Type: dropdown
        Ref:  Control/IDs/GC_Value
     */
    public static View get_Control_IDs_GCValue(Solo solo) {
        String ref = "Control/IDs/GC_Value";
        return (android.view.View) solo.getView((Object) ref);
    }
